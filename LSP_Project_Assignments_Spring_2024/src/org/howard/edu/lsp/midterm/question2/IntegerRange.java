...
/**
 * The IntegerRange class represents a range of integers defined by a lower and
 * upper bound. It implements the Range interface.
 */
public class IntegerRange implements Range {
	...
	public boolean overlaps(Range other) {
		return this.contains(((IntegerRange) other).lowerBound) || this.contains(((IntegerRange) other).upperBound);
	}
